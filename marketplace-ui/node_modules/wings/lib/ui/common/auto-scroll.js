...
var AutoScroll = function (_React$Component) {
  ...
  function AutoScroll() {
    ...
    return _possibleConstructorReturn(this, (AutoScroll.__proto__ || Object.getPrototypeOf(AutoScroll)).apply(this, arguments));
  }

  _createClass(AutoScroll, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      if (!(0, _domUtils.isElementInViewport)(this._node)) {
