...
func GetRoutes(db *gorm.DB) map[string]controllers.IController {
	...
	shippingMethodService := services.NewShippingMethodService(shippingMethodRepository, stockItemRepository)
	...
	return map[string]controllers.IController{
		...
		"v1/public/order-shipping-methods": controllers.NewOrderShippingMethodController(shippingMethodService),
