...
func (repository *StockItemUnitRepositoryMock) HoldUnits(orderRefNum string, skuCode string, qty uint) ([]*models.StockItemUnit, error) {
	args := repository.Called(orderRefNum, skuCode, qty)
