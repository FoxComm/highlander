...
object ImageResponses {
  ...
  object AlbumResponse {
    case class Root(id: Int, name: String, images: Seq[Image],
      createdAt: Instant, updatedAt: Instant) extends ResponseItem
    ...
    def build(album: FullObject[Album], images: Seq[Image]): Root = {
      ...
      Root(id = album.form.id, name = name, images = images,
