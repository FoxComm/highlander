...
final case class GiftCardAdjustment(id: Int = 0, giftCardId: Int, orderPaymentId: Int,
  credit: Int, debit: Int, availableBalance: Int, status: Status = Auth, createdAt: Instant = Instant.now())
...
class GiftCardAdjustments(tag: Tag)
  ...
  def * = (id, giftCardId, orderPaymentId, credit, debit, availableBalance,
