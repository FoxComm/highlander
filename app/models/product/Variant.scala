 ...
 */
case class Variant(id: Int = 0, variantType: String, contextId: Int, shadowId: Int, formId: Int,
...
class Variants(tag: Tag) extends ObjectHeads[Variant](tag, "variants") {
  ...
  def * = (id, variantType, contextId, shadowId, formId, commitId, updatedAt,
    createdAt) <> ((Variant.apply _).tupled, Variant.unapply)
}

object Variants extends FoxTableQuery[Variant, Variants](new Variants(_))
