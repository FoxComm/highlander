 ...
 */
final case class CouponUsage(id: Int = 0, couponFormId: Int, count: Int, 
...
class CouponUsages(tag: Tag) extends FoxTable[CouponUsage](tag, "coupon_usages")  {
  ...
  def * = (id, couponFormId, count, updatedAt, createdAt) <> ((CouponUsage.apply _).tupled, CouponUsage.unapply)

}

object CouponUsages extends FoxTableQuery[CouponUsage, CouponUsages](new CouponUsages(_))
