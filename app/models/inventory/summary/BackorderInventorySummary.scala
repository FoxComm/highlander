...
case class BackorderInventorySummary(id: Int = 0,
                                     onHand: Int,
                                     onHold: Int,
                                     reserved: Int,
...
class BackorderInventorySummaries(tag: Tag)
    extends InventorySummariesTableBase[BackorderInventorySummary](
        tag, "backorder_inventory_summaries") {

  def * =
    (id, onHand, onHold, reserved, availableForSale, updatedAt) <> ((BackorderInventorySummary.apply _).tupled,
...
object BackorderInventorySummaries
  ...
  val returningLens: Lens[BackorderInventorySummary, (Int, Int)] =
