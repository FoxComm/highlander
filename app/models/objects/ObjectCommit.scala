...
class ObjectCommits(tag: Tag) extends GenericTable.TableWithId[ObjectCommit](tag, "form_commits")  {
  ...
  def * = (id, shadowId, formId, reasonId, previousId, createdAt) <> ((ObjectCommit.apply _).tupled, ObjectCommit.unapply)
