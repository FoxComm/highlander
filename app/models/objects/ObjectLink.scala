...
/**
  ...
  *
  */
case class ObjectLink(id: Int = 0,
                      leftId: Int,
                      rightId: Int,
...
class ObjectLinks(tag: Tag) extends FoxTable[ObjectLink](tag, "object_links") {
  ...
  def * =
    (id, leftId, rightId, linkType, createdAt, updatedAt) <> ((ObjectLink.apply _).tupled, ObjectLink.unapply)
...
object ObjectLinks
    extends FoxTableQuery[ObjectLink, ObjectLinks](new ObjectLinks(_))
