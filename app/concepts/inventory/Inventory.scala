...
trait InventoryItem extends OnHand with Holdable with Reservable with NonSellable {

  def safetyStock(): Int
}

trait InventoryItems extends Handy with Reservables with Holdables with NonSellables {
