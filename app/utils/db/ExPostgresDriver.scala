...
trait ExPostgresDriver
  ...
  object MyAPI
    ...
    implicit val json4sJsonArrayTypeMapper: DriverJdbcType[List[Json]] =
      new AdvancedArrayJdbcType[Json](pgjson, (s) ⇒
            SimpleArrayUtils.fromString[Json](jsonMethods.parse(_))(s).orNull, (v) ⇒
            SimpleArrayUtils.mkString[Json](_.toString())(v)).to(_.toList)
  }
}
