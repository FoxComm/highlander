...
trait CustomerSeeds {
  ...
  def usCustomer1 = Customer.build(email = "yax@yax.com", password = "password".some,
    name = Some("Yax Fuentes"), phoneNumber = Some("123-444-4388"),
    location = Some("DonkeyVille, TN"), modality = Some("Desktop"))

  def usCustomer2 = Customer.build(email = "adil@adil.com", password = "password".some,
  ...
  def canadaCustomer = Customer.build(email = "iamvery@sorry.com", password = "password".some,
    name = Some("John Nicholson"), phoneNumber = Some("858-867-5309"),
    location = Some("Donkeyburg, Canada"), modality = Some("Tablet"),
    isGuest = true)

  def rowCustomer = Customer.build(email = "fran@absinthelovers.cz", password = "password".some,
