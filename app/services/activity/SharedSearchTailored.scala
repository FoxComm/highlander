...
object SharedSearchTailored {
  case class AssociatedWithSearch(admin: StoreAdminResponse.Root, search: SharedSearch,
    associates: Seq[StoreAdminResponse.Root])
    extends ActivityBase[AssociatedWithSearch]

  case class UnassociatedFromSearch(admin: StoreAdminResponse.Root, search: SharedSearch,
