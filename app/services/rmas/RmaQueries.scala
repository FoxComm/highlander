...
object RmaQueries {
  ...
  def findAllDbio(query: Rmas.QuerySeq)(
    ...
    val sortedQuery = withStoreAdmins.withMetadata.sortAndPageIfNeeded {
      case (s, ((rma, customer), admin)) ⇒
        s.sortColumn match {
