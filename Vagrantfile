...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :appliance, primary: true do |app|
    ...
    app.vm.provision "ansible" do |ansible|
      ...
      ansible.playbook = "prov-shit/ansible/playbooks/vagrant/appliance.yml"
      ansible.extra_vars = {
        user: user
      }
    end
  ...
  config.vm.define :appliance_base, autostart: false do |app|
    ...
    app.vm.provision "ansible" do |ansible|
      ansible.verbose = "vvvv"
      ansible.playbook = "prov-shit/ansible/playbooks/vagrant/appliance_base.yml"
      ansible.extra_vars = {
        user: user
      }
    end
  ...
  config.vm.define :build_base, autostart: false do |app|
    ...
    app.vm.provision "ansible" do |ansible|
      ...
      ansible.playbook = "prov-shit/ansible/playbooks/vagrant/builder.yml"
      ansible.extra_vars = {
        user: user
      }
    end
