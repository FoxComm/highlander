...
def tune_vm(config, opts = {})
  config.vm.provider :google do |g, override|
    ...
    g.image = "appliance-base-170201-234140"
    g.disk_size = 40
    ...
    app.vm.provision "ansible" do |ansible|
      ...
      ansible.extra_vars = {
        ...
        docker_tags: {
            ...
            bernardo: ENV['DOCKER_TAG_BERNARO'] || "master",
            henhouse: ENV['DOCKER_TAG_HENHOUSE'] || "master",
            eggcrate: ENV['DOCKER_TAG_EGGCRATE'] || "master",
            river_rock: ENV['DOCKER_TAG_RIVER_ROCK'] || "master",
            digger_sphex: ENV['DOCKER_TAG_DIGGER_SPHEX'] || "master"
        }
      }
    end
  end
