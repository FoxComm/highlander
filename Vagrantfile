...
def tune_vm(config, opts = {})
  ...
  config.vm.provider :google do |g, override|
    ...
    g.image = "appliance-base-1474217336"
    g.disk_size = 20
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :appliance, primary: true do |app|
    app.vm.box = "base_appliance_16.04_20160918"
    app.vm.box_url = "https://s3.amazonaws.com/fc-dev-boxes/base_appliance_16.04_20160918.box"
