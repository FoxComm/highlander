defmodule OnboardingService.MerchantProductsUploadController do
  use OnboardingService.Web, :controller

  alias Ecto.Multi
  alias OnboardingService.ProductsUpload
  alias OnboardingService.ProductsUploadView
  alias OnboardingService.MerchantProductsUpload
