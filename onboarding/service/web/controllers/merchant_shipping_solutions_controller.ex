defmodule OnboardingService.MerchantShippingSolutionController do
  use OnboardingService.Web, :controller
  alias Ecto.Multi
  alias OnboardingService.Repo
  alias OnboardingService.ShippingSolution
  alias OnboardingService.MerchantShippingSolution
  alias OnboardingService.ShippingSolutionView
