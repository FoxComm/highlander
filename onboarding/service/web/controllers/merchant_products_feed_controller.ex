defmodule OnboardingService.MerchantProductsFeedController do
  use OnboardingService.Web, :controller

  alias Ecto.Multi
  alias OnboardingService.ProductsFeed
  alias OnboardingService.ProductsFeedView
  alias OnboardingService.MerchantProductsFeed
