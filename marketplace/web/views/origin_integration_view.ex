defmodule Marketplace.OriginIntegrationView do
  ...
  def render("show.json", %{origin_integration: origin_integration}) do
    %{origin_integration: render_one(origin_integration, Marketplace.OriginIntegrationView, "origin_integration.json")}
  end
end
