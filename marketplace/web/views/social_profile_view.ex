defmodule Marketplace.SocialProfileView do 
  use Marketplace.Web, :view

  def render("index.json", %{social_profiles: social_profiles}) do
    %{social_profiles: render_many(social_profiles, Marketplace.SocialProfileView, "social_profile.json")}
  end
  ...
  def render("show.json", %{social_profile: social_profile}) do 
    %{social_profile: render_one(social_profile, Marketplace.SocialProfileView, "social_profile.json")}
  end
end
