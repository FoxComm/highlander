...
import CategoryPerfume from 'pages/catalog/category-perfume';
  ...
  return (
    <Route path="/" component={Site}>
      ...
      <Route component={StoreFront}>
        ...
        <Route name="category-hero-perfume" path="/categories/perfume" component={CategoryPerfume} fullWidth />
