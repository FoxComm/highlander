...
class Products extends Component {
  ...
  renderTitle() {
    ...
    const desc = _.get(category, 'shortDescription', '');
...
/*      { component: 'Newest', onSelect: () => this.changeSorting('createdAt', ASC) }, -- No field in ES */
      { component: 'Name: A to Z', onSelect: () => this.changeSorting('title.raw', ASC) },
      { component: 'Name: Z to A', onSelect: () => this.changeSorting('title.raw', DESC) },
