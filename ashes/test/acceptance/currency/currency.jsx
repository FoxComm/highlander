...
describe('Currency', function() {
  ...
  it('should render empty tag with incorrect value', function() {
    expect(Currency({ value: 'abc' }), 'to equal', <span className="fc-currency" />);
  });

  it('should render correct value', function() {
    expect(Currency({ value: 123, currency: 'USD' }), 'to equal', <span className="fc-currency">$1.23</span>);
  });
  ...
  it('should support another currency', function() {
    expect(Currency({ value: 123, currency: 'EUR' }), 'to equal', <span className="fc-currency">€1.23</span>);
  });
