...
describe('Alert', function() {
  it('should render success Alert', function() {
    const alert = shallow(<Alert type={Alert.SUCCESS}>Success</Alert>);
  ...
  it('should render warning Alert', function() {
    const alert = shallow(<Alert type={Alert.WARNING}>Warning</Alert>);
  ...
  it('should render error Alert', function() {
    const alert = shallow(<Alert type={Alert.ERROR}>Error</Alert>);
  ...
  it('should handle close click', function() {
    ...
    const alert = shallow(<Alert type={Alert.ERROR} closeAction={onClick}>Error</Alert>);
