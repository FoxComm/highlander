...
describe('Buttons', function() {
  it('should render Button', function() {
    const button = shallow(<Buttons.Button>Done</Buttons.Button>);

    expect(button.text()).to.equal('Done');
  });

  it('should render Button with icon and text', function() {
    const button = shallow(<Buttons.Button icon="fake">Done</Buttons.Button>);
  ...
  it('should render loading state', function() {
    const button = shallow(<Buttons.Button isLoading>Done</Buttons.Button>);
  ...
  it('should handle click', function() {
    ...
    const button = shallow(<Buttons.Button onClick={onClick}>Done</Buttons.Button>);
  ...
  it('should render className in PrimaryButton', function() {
    ...
    const button = shallow(<Buttons.PrimaryButton className={className} />);
  ...
  it('should not handle click when disabled', function() {
    ...
    const button = mount(<Buttons.Button onClick={onClick} disabled>Done</Buttons.Button>);
  ...
  it('should not handle click when loading', function() {
    ...
    const button = mount(<Buttons.Button onClick={onClick} isLoading>Done</Buttons.Button>);
  ...
  it('should render icon in CloseButton', function() {
    const button = mount(<Buttons.CloseButton />);
  ...
  it('should render icon in SocialButton with google icon', function() {
    const button = mount(<Buttons.SocialButton type="google" />);
