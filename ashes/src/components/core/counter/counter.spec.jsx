...
describe('Counter', function() {
  ...
  it('should handle click on DecrementButton', function() {
    ...
    const counter = mount(<Counter value={1} className="test" onChange={onChange} />);
