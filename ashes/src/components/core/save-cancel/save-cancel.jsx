...
export default class SaveCancel extends Component {
  ...
  get cancel() {
    const { cancelTabIndex, onCancel, cancelText, cancelDisabled } = this.props;
  ...
  get primary() {
    const { saveTabIndex, saveText, saveItems, saveDisabled, onSave, onSaveSelect, isLoading } = this.props;
