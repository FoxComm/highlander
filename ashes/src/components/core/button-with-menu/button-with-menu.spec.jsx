...
describe('ButtonWithMenu', function() {
  it('should render ButtonWithMenu', function() {
    const button = mount(<ButtonWithMenu title="Save" items={[]} />);
  ...
  it('should render ButtonWithMenu with icon', function() {
    const button = mount(<ButtonWithMenu title="Save" items={[]} icon="edit" />);
  ...
  it('should render loading state', function() {
    const button = mount(<ButtonWithMenu title="Save" items={[]} isLoading />);
  ...
  it('should handle action button click', function() {
    ...
    const button = mount(<ButtonWithMenu title="Save" items={[]} onPrimaryClick={onClick} />);
  ...
  it('should not handle action button click when disabled', function() {
    const onClick = sinon.spy();
    const button = mount(<ButtonWithMenu title="Save" items={[]} onPrimaryClick={onClick} buttonDisabled />);
  ...
  it('should open menu on menu button click', function() {
    const button = mount(
      <ButtonWithMenu title="Save" items={[['id1', 'Save and Exit'], ['id2', 'Save and Duplicate']]} />
    );
  ...
  it('should not open menu on disabled menu button click', function() {
    const button = mount(<ButtonWithMenu title="Save" items={[]} menuDisabled />);
