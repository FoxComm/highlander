...
const _fetchCatalog = createAsyncActions('fetchCatalog', (id: number) => Api.get(`/catalogs/${id}`));

const _createCatalog = createAsyncActions('createCatalog', (payload: any) => Api.post('/catalogs', payload));

const _updateCatalog = createAsyncActions('updateCatalog', (id: number, payload: any) =>
