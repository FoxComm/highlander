...
// state for content type adding form
...
const _createAction = (desc, ...args) => createAction(`CONTENT_TYPES_NEW_${desc}`, ...args);
...
const quickSearch = makeQuickSearch(
  'contentTypes.adding.suggestedCustomers',
...
export function fetchTypes() {
  return dispatch => {
    Api.get(`/public/content-types/types`)
      .then(
