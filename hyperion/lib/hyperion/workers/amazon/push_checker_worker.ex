defmodule Hyperion.Amazon.Workers.PushCheckerWorker do
  ...
  def check_feeds_status(pushes) do
  ...
  def check_feed(push, feed_name, cfg) do
  ...
  def store_result(push_id, feed_result_name, result) do
