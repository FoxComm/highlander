...
alter table stock_item_summaries add column stock_item_type_id integer not null references stock_item_types(id) on update restrict on delete restrict default 1;
