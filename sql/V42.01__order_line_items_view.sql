...
select
    ...
    then
        ...
        json_agg((oli.state, 
                ...
                sku.attributes->'price'->>(sku_shadow.attributes->>'price'))::export_line_items)
    end as items
from orders as o
...
left join product_shadows as product_shadow on (oli_skus.product_shadow_id = product_shadow.id)
