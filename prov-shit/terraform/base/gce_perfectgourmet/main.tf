...
resource "google_compute_network" "perfectgourmet" {
  name       = "${var.network}"
  ipv4_range = "10.0.0.0/16"
}

resource "google_compute_firewall" "perfectgourmet_web" {
...
resource "google_compute_firewall" "perfectgourmet_ssh" {
...
resource "google_compute_firewall" "perfectgourmet_internal" {
