...
trait PhoenixAdminApi extends HttpSupport { self: FoxSuite ⇒
  ...
  case class customersApi(id: Int) {
    ...
    object payments {
      ...
      case class creditCard(id: Int) {
        ...
        def toggleDefault(payload: ToggleDefaultCreditCard)(
            implicit aa: TestAdminAuth): HttpResponse =
          POST(s"$creditCardPath/default", payload, aa.jwtCookie.some)
  ...
  case class cartsApi(refNum: String) {
    ...
    object lineItems {
      ...
      // TODO rename to "set" or something
  ...
  object customerGroupsApi {
    ...
    def get()(implicit aa: TestAdminAuth): HttpResponse =
      GET(customerGroupsPrefix, aa.jwtCookie.some)

    def create(payload: CustomerDynamicGroupPayload)(implicit aa: TestAdminAuth): HttpResponse =
  ...
  case class customerGroupsApi(id: Int) {
    ...
    def update(payload: CustomerDynamicGroupPayload)(implicit aa: TestAdminAuth): HttpResponse =
  ...
  case object taxonomiesApi {
    def create(payload: CreateTaxonomyPayload)(implicit ctx: OC, aa: TestAdminAuth) =
  ...
  case class taxonomiesApi(taxonomyId: Int)(implicit ctx: OC) {
    ...
    def createTaxon(payload: CreateTaxonPayload)(implicit aa: TestAdminAuth): HttpResponse =
      POST(s"v1/taxonomies/${ctx.name}/$taxonomyId", payload, aa.jwtCookie.some)
  }
