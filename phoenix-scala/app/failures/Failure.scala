...
case class AlreadySavedForLater(accountId: Int, variantId: Int) extends Failure {
  override def description =
    s"Customer with id=$accountId already has variant with id=$variantId saved for later"
}
