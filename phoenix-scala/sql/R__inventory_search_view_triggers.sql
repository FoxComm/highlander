...
begin
  insert into inventory_search_view select
    new.id as id,
...
begin
  update inventory_search_view set
    ...
    from (select
      ...
      where subquery.id = inventory_search_view.id;
...
begin
  update inventory_search_view set
    ...
    from (select
      ...
      where subquery.variant_id = inventory_search_view.id;
