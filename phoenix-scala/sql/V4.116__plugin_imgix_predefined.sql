insert into plugins
    ...
    '{"s3_bucket": "", "s3_prefix": "", "cdn_prefix": ""}'::jsonb,
                     ('[{"name": "cdn_prefix", "type": "string", "title": "Imgix source url", "default": ""},' ||
    ' {"name": "s3_bucket", "type": "string", "title": "S3 bucket", "default": ""}, ' ||
    '{"name": "s3_prefix", "type": "string", "title": "S3 prefix", "default": "albums"}]')::jsonb,
