...
class ConditionTest extends TestBase {
  "Condition" - {
    "#matches(Int, Condition)" - {
      "Equals" - {
        "returns true when values are equal" in {
          val c = Factories.condition.copy(operator = Condition.Equals, valInt = Some(50), valString = None)
      ...
      "NotEquals" - {
        "returns false when values are equal" in {
          val c = Factories.condition.copy(operator = Condition.NotEquals, valInt = Some(50), valString = None)
          val result = Condition.matches(50, c)
          result must === (false)
        }
      ...
      "GreaterThan" - {
        "returns true when value is greater than condition" in {
          val c = Factories.condition.copy(operator = Condition.GreaterThan, valInt = Some(50), valString = None)
          val result = Condition.matches(51, c)
          result must === (true)
        }
      ...
      "LessThan" - {
        "returns false when value is greater than condition" in {
          val c = Factories.condition.copy(operator = Condition.LessThan, valInt = Some(50), valString = None)
          val result = Condition.matches(51, c)
          result must === (false)
        }
      ...
      "GreaterThanOrEquals" - {
        "returns true when value is greater than condition" in {
          val c = Factories.condition.copy(operator = Condition.GreaterThanOrEquals, valInt = Some(50), valString = None)
          val result = Condition.matches(51, c)
          result must === (true)
        }
      ...
      "LessThanOrEquals" - {
        "returns false when value is greater than condition" in {
          val c = Factories.condition.copy(operator = Condition.LessThanOrEquals, valInt = Some(50), valString = None)
          val result = Condition.matches(51, c)
          result must === (false)
        }
    ...
    "#matches(String, Condition)" - {
      "Equals" - {
        "returns true when values are equal" in {
          val c = Factories.condition.copy(operator = Condition.Equals, valString = Some("some string"))
      ...
      "NotEquals" - {
        "returns false when values are equal" in {
          val c = Factories.condition.copy(operator = Condition.NotEquals, valString = Some("some string"))
          val result = Condition.matches("some string", c)
          result must === (false)
        }
      ...
      "Contains" - {
        "returns true with the condition contains the value" in {
          val c = Factories.condition.copy(operator = Condition.Contains, valString = Some("me str"))
          val result = Condition.matches("some string", c)
          result must === (true)
        }
      ...
      "NotContains" - {
        "returns false with the condition contains the value" in {
          val c = Factories.condition.copy(operator = Condition.NotContains, valString = Some("me str"))
          val result = Condition.matches("some string", c)
          result must === (false)
        }
