...
describe('Return Notes #GET', function() {
  it('should get a list of notes', function *() {
    let
      res     = yield this.api.get('/returns/1/notes'),
      notes   = res.response;
...
describe('Return Notes #POST', function() {
  it('should create a note', function *() {
    let
      data    = {body: 'this is a note'},
      res     = yield this.api.post('/returns/1/notes', data),
      note    = res.response;
