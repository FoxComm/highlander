...
describe('Return Notifications #GET', function() {

  it('should get a list of notifications', function *() {
    let
      res     = yield this.api.get('/returns/1/notifications'),
...
describe('Return Notifications #POST', function() {

  it('should resend a notification', function *() {
    let
      data    = {},
      res     = yield this.api.post('/returns/1/notifications/1', data),
