...
object StripeSupport {
  ...
  def successfulCard: String =
    this.successfulCards.getOrElse("Visa", dummyDefaultValue)

  def declinedCard: String =
    this.failureCards.getOrElse("card_declined", dummyDefaultValue)

  def failureCard: String = this.declinedCard

  def incorrectNumberCard: String =
    this.failureCards.getOrElse("incorrect_number", dummyDefaultValue)

  def incorrectCvc: String =
    this.failureCards.getOrElse("incorrect_cvc_code", dummyDefaultValue)
}
