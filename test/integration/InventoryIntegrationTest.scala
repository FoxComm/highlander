      ...
      skuResponse must contain allOf (
          ...
          SkuDetailsResponse.Root(
              ...
              SkuCounts(sellable.onHand,
                        ...
                        sellable.availableForSale * Mvp.priceAsInt(skuForm, skuShadow))),
          // backorder
          SkuDetailsResponse.Root(
              Backorder,
              SkuCounts(backorder.onHand,
                        ...
                        backorder.availableForSale * Mvp.priceAsInt(skuForm, skuShadow))),
          // preorder
          SkuDetailsResponse.Root(
              Preorder,
              SkuCounts(preorder.onHand,
                        ...
                        preorder.availableForSale * Mvp.priceAsInt(skuForm, skuShadow))),
          // nonsellable
          SkuDetailsResponse.Root(
              NonSellable,
              SkuCounts(nonsellable.onHand,
                        ...
                        nonsellable.availableForSale * Mvp.priceAsInt(skuForm, skuShadow)))
      )
    }
      ...
      summaries must contain allOf (
          ...
          SellableSkuSummaryResponse.Root(
              ...
              SkuCounts(sellable2.onHand,
                        ...
                        sellable2.availableForSale * Mvp.priceAsInt(skuForm, skuShadow)))
      )
    }
