...
export function saveShippingAddress(): Function {
  return (dispatch, getState, jwt) => {
    ...
    return phoenix.addAuth(jwt).post('/v1/my/cart/shipping-address', payload)
      .then(res => {
...
export function saveShippingMethod(): Function {
  return (dispatch, getState, jwt) => {
    ...
    return phoenix.addAuth(jwt).patch('/v1/my/cart/shipping-method', payload)
      .then(res => {
        dispatch(updateCart(res.result));
      });
  };
...
export function saveGiftCard(code: string): Function {
  return (dispatch, getState, jwt) => {
    ...
    return phoenix.addAuth(jwt).post('/v1/my/cart/payment-methods/gift-cards', payload)
      .then(res => {
        dispatch(updateCart(res.result));
      });
  };
...
export function addCreditCard(): Function {
  return (dispatch, getState, jwt) => {
    ...
    const phoenixWithAuth = () => phoenix.addAuth(jwt);
...
export function checkout(): Function {
  return (dispatch, getState, jwt) => {
    return phoenix.addAuth(jwt).post('/v1/my/cart/checkout').then(res => {
