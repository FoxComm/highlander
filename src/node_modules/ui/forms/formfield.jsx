...
export default class FormField extends React.Component {
  ...
  validate() {
    ...
    const label = this.props.label || 'This field';

    if (!_.isString(value) || value) {
      if (this.props.maxLength && _.isString(value) && value.length > this.props.maxLength) {
        errors = [...errors, `Can not be more than ${this.props.maxLength} characters`];
      }
  ...
  render() {
    ...
    const restProps = {className: this.props.className};

    return (
      <div styleName={styleName} {...restProps}>
        {this.props.children}
        {this.errorMessages}
      </div>
    );
