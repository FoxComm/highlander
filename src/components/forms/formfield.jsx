...
import styles from './css/formfield.css';
...
export default class FormField extends React.Component {
  ...
  get label() {
    if (this.props.label) {
      const optionalMark = 'optional' in this.props ? <span styleName="optional">(optional)</span> : null;
      return (
        <label styleName="label" htmlFor={this.state.targetId}>
          {this.props.label}
          {optionalMark}
        </label>
      );
  ...
  render() {
    ...
    return (
      <div styleName="form-field" className={this.props.className}>
        {content}
        {this.errorMessages}
      </div>
    );
